...
//   final String file;
//
//   const AudioControl({Key? key,required this.file, required this.controller}) : super(key: key);
//   @override
...
//                     onPressed: () async {
//                       print(widget.controller.audioState);
//                       if( widget.controller.audioState == AudioState.STOPPED ){
//                         await widget.controller.start(widget.file);
//                         setState(() =>
//                         widget.controller.audioState = AudioState.PLAYING);
//                       }else if( widget.controller.audioState == AudioState.PLAYING || widget.controller.audioState == AudioState.PAUSE ){
